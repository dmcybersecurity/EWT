# -*- coding: utf-8 -*-
"""Copy of EXOTIC Standard.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1HayRVKGKUK9xD4NAeKR-U5Ckov9qpDW4
...
#   # Force user to re-run to get latest bokeh version
#   appendStepToContainer('.step_container_1a','<span class="error">ERROR: You have an old version of Bokeh loaded (pre-2.4.3). <b>Please re-run this step by clicking the run arrow above.</b></span>')
#   showProgress(2) # must wait before killing so the error has time to display
#   import os
#   os.kill(os.getpid(), 9)
# else:
#   showProgress(.3) 
...
Star = 'HAT-P-32' #@param {type:"string"}
Target = Star
